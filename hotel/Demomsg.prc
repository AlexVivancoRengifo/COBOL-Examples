@POWER POWSHEET DEMOMSG WORKING
******************************************************************
*		SHEET(ITEM)	===>	DEMOMSG
*		EVENT		===>	WORKING
...
******************************************************************
*
		MOVE	MSG-ERR			TO	POW-TEXT OF MSG.
*
	MAIN-EX.
		EXIT	PROGRAM.
@POWER POWPSBTN PUSHOK CLICK
 ENVIRONMENT DIVISION.
 DATA        DIVISION.
 PROCEDURE   DIVISION.
******************************************************************
...
******************************************************************
*
 	CALL	CLOSESHEET OF DEMOMSG	USING	"DEMOMSG".
*
 MAIN-EX.
 	EXIT	PROGRAM.
