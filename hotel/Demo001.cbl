...
000017*    GLOBAL AREA
000018*
000019 01  GL-AREA     IS  GLOBAL.
000020     03  WORK-AREA.
000021         05  WK-STRNG            PIC X(64).
000022*
000023*    EXTERNAL AREA
000024*
...
000087*
000088 01 POWER--HPOWOBJS-DEMO001 IS GLOBAL IS EXTERNAL.
000089   02 POWER--HPOWOBJ--DEMO001.
000089     03 DEMO001 PIC S9(9) COMP-5.
000089     03 POW-P001 REDEFINES  DEMO001 USAGE POINTER.
000089   02 POWER--HPOWOBJ--GROUP1.
000089     03 GROUP1 PIC S9(9) COMP-5.
000089     03 POW-P002 REDEFINES  GROUP1 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHS1.
000089     03 PUSHS1 PIC S9(9) COMP-5.
000089     03 POW-P003 REDEFINES  PUSHS1 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHS2.
000089     03 PUSHS2 PIC S9(9) COMP-5.
000089     03 POW-P004 REDEFINES  PUSHS2 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHW.
000089     03 PUSHW PIC S9(9) COMP-5.
000089     03 POW-P005 REDEFINES  PUSHW USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHT1.
000089     03 PUSHT1 PIC S9(9) COMP-5.
000089     03 POW-P006 REDEFINES  PUSHT1 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHT2.
000089     03 PUSHT2 PIC S9(9) COMP-5.
000089     03 POW-P007 REDEFINES  PUSHT2 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHSU.
000089     03 PUSHSU PIC S9(9) COMP-5.
000089     03 POW-P008 REDEFINES  PUSHSU USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL16.
000089     03 LABEL16 PIC S9(9) COMP-5.
000089     03 POW-P009 REDEFINES  LABEL16 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL15.
000089     03 LABEL15 PIC S9(9) COMP-5.
000089     03 POW-P010 REDEFINES  LABEL15 USAGE POINTER.
000089   02 POWER--HPOWOBJ--GROUP2.
000089     03 GROUP2 PIC S9(9) COMP-5.
000089     03 POW-P011 REDEFINES  GROUP2 USAGE POINTER.
000089   02 POWER--HPOWOBJ--ROOMTBL.
000089     03 ROOMTBL PIC S9(9) COMP-5.
000089     03 POW-P012 REDEFINES  ROOMTBL USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL2.
000089     03 LABEL2 PIC S9(9) COMP-5.
000089     03 POW-P013 REDEFINES  LABEL2 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL3.
000089     03 LABEL3 PIC S9(9) COMP-5.
000089     03 POW-P014 REDEFINES  LABEL3 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL4.
000089     03 LABEL4 PIC S9(9) COMP-5.
000089     03 POW-P015 REDEFINES  LABEL4 USAGE POINTER.
000089   02 POWER--HPOWOBJ--GROUP3.
000089     03 GROUP3 PIC S9(9) COMP-5.
000089     03 POW-P016 REDEFINES  GROUP3 USAGE POINTER.
000089   02 POWER--HPOWOBJ--RSVLIST.
000089     03 RSVLIST PIC S9(9) COMP-5.
000089     03 POW-P017 REDEFINES  RSVLIST USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL11.
000089     03 LABEL11 PIC S9(9) COMP-5.
000089     03 POW-P018 REDEFINES  LABEL11 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL12.
000089     03 LABEL12 PIC S9(9) COMP-5.
000089     03 POW-P019 REDEFINES  LABEL12 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL13.
000089     03 LABEL13 PIC S9(9) COMP-5.
000089     03 POW-P020 REDEFINES  LABEL13 USAGE POINTER.
000089   02 POWER--HPOWOBJ--LABEL14.
000089     03 LABEL14 PIC S9(9) COMP-5.
000089     03 POW-P021 REDEFINES  LABEL14 USAGE POINTER.
000089   02 POWER--HPOWOBJ--PUSHEND.
000089     03 PUSHEND PIC S9(9) COMP-5.
000089     03 POW-P022 REDEFINES  PUSHEND USAGE POINTER.
000090 01  REDEFINES POWER--HPOWOBJS-DEMO001.
000091   02  POWER--HPOWOBJS PICTURE IS X(4) OCCURS 22 TIMES.
000092 LOCAL-STORAGE SECTION.
000093 LINKAGE SECTION.
000094 01  POWER--HPOWOBJ IS GLOBAL PICTURE IS  X(4).
000095 01  POWER--ID      IS GLOBAL PICTURE IS S9(4)
000096                    USAGE IS COMPUTATIONAL-5.
000097 01  POWER--NOTIFY  IS GLOBAL PICTURE IS S9(4)
000098                    USAGE IS COMPUTATIONAL-5.
000099 01  POWER--MESSAGE IS GLOBAL PICTURE IS S9(4)
000100                    USAGE IS COMPUTATIONAL-5.
000101 PROCEDURE DIVISION
000102     USING POWER--HPOWOBJ POWER--ID POWER--MESSAGE POWER--NOTIFY.
000103     EVALUATE POWER--MESSAGE
000104     WHEN 1025
000105         EVALUATE POWER--HPOWOBJ
000106         WHEN POWER--HPOWOBJ--RSVLIST
000107             EVALUATE POWER--NOTIFY
000108             WHEN 2 
000109                CALL "RSVLIST-DBLCLICK"
000110             END-EVALUATE
000111         WHEN POWER--HPOWOBJ--PUSHS1
000112             EVALUATE POWER--NOTIFY
000113             WHEN 1 
000114                CALL "PUSHS1-CLICK"
000115             END-EVALUATE
000116         WHEN POWER--HPOWOBJ--PUSHS2
000117             EVALUATE POWER--NOTIFY
000118             WHEN 1 
000119                CALL "PUSHS2-CLICK"
000120             END-EVALUATE
000121         WHEN POWER--HPOWOBJ--PUSHW
000122             EVALUATE POWER--NOTIFY
000123             WHEN 1 
000124                CALL "PUSHW-CLICK"
000125             END-EVALUATE
000126         WHEN POWER--HPOWOBJ--PUSHSU
000127             EVALUATE POWER--NOTIFY
000128             WHEN 1 
000129                CALL "PUSHSU-CLICK"
000130             END-EVALUATE
000131         WHEN POWER--HPOWOBJ--PUSHT1
000132             EVALUATE POWER--NOTIFY
000133             WHEN 1 
000134                CALL "PUSHT1-CLICK"
000135             END-EVALUATE
000136         WHEN POWER--HPOWOBJ--PUSHT2
000137             EVALUATE POWER--NOTIFY
000138             WHEN 1 
000139                CALL "PUSHT2-CLICK"
000140             END-EVALUATE
000141         WHEN POWER--HPOWOBJ--PUSHEND
000142             EVALUATE POWER--NOTIFY
000143             WHEN 1 
000144                CALL "PUSHEND-CLICK"
000145             END-EVALUATE
000146         END-EVALUATE
000147     WHEN 1024
000148         MOVE POWER--HPOWOBJ TO POWER--HPOWOBJS (POWER--ID + 1)
000149     WHEN 1036
000150         CALL "DEMO001-OPENED"
000151     WHEN 1049
000152         CALL "DEMO001-CLOSECHILD"
000153     WHEN 1038
000154         CALL "DEMO001-START"
000155     END-EVALUATE
000156     EXIT PROGRAM.
000157 IDENTIFICATION DIVISION.
000158 PROGRAM-ID. "DEMO001-OPENED".
000159 ENVIRONMENT DIVISION.
000160 DATA        DIVISION.
000161 WORKING-STORAGE         SECTION.
000162*
000163 01  WORK-AREA.
000164     03  WK-TYPE             PIC X(2).
000165     03  WK-ROOMNO           PIC X(4).
000166     03  WK-ALL              PIC 9999.
000167     03  WK-RSV              PIC 9999.
000168     03  WK-COMP             PIC S9(8)V9(8).
000169     03  WK-RITU             PIC ZZ9.9.
000170     03  WK-RITU-D           PIC X(06).
000171     03  WK-YOYAKUDATE       PIC X(08).
000172     03  WK-YOYAKUNO         PIC X(09).
000173     03  WK-YOYAKURNO        PIC X(04).
000174     03  WK-ROOMTYPE         PIC X(02).
000175     03  WK-TBL-IDX          PIC S9(04)  COMP-5.
000175 77 POW-0001 PIC S9(14)V9(4) .
000175 77 POW-0002 PIC S9(4) COMP-5 .
000175 77 POW-0003 PIC S9(4) COMP-5 .
000175 77 POW-0004 PIC S9(14)V9(4) .
000175 77 POW-0005 PIC S9(4) COMP-5 .
000175 77 POW-0006 PIC S9(4) COMP-5 .
000175 77 POW-0007 PIC X(56) .
000175 77 POW-0008 PIC S9(4) COMP-5 .
000175 77 POW-0009 PIC S9(4) COMP-5 .
000175 77 POW-0010 PIC X(64) .
000176*
...
000181*
000182*
000183***  RSV-INFORMATION TABLE EDIT  ***
000184*
000185     PERFORM TBLEDIT VARYING TBL-IDX FROM    1   BY  1
000186             UNTIL   TBL-IDX     >   7.
000187*
000188***  RSV-LIST EDIT   ***
000189*
000190     PERFORM LSTEDIT VARYING TBL-IDX FROM    1   BY  1
000191         UNTIL   TBL-IDX >   ROOM-RSV-NUM(7) OR  TBL-IDX >   100.
000192*
000193 MAIN-END.
000194     EXIT    PROGRAM.
000195*
000196******************************************************************
000197 TBLEDIT                 SECTION.
000198******************************************************************
000199*
...
000205     CALL   "_XPOWTABLESETNUMERICTO"  USING BY VALUE ROOMTBL
000205      BY REFERENCE POW-0001  BY VALUE POW-0002 POW-0003 .
000206     MOVE  WK-RSV  TO POW-0004.
000206     MOVE  TBL-IDX  TO POW-0005.
000206     MOVE  2  TO POW-0006.
000206     CALL   "_XPOWTABLESETNUMERICTO"  USING BY VALUE ROOMTBL
000206      BY REFERENCE POW-0004  BY VALUE POW-0005 POW-0006 .
000207     MOVE  WK-RITU-D  TO POW-0007.
000207     MOVE  TBL-IDX  TO POW-0008.
000207     MOVE  3  TO POW-0009.
000207     CALL   "_XPOWTABLESETALPHANUMERICTO"  USING BY VALUE ROOMTBL
000207      BY REFERENCE POW-0007  BY VALUE POW-0008 POW-0009 .
000208*
000209 TBLEDIT-EX.
000210     EXIT.
000211*
...
000244     CALL    "_XPOWLISTADDSTRING"  USING BY VALUE RSVLIST
000244      BY REFERENCE POW-0010 .
000245*
000246 LSTEDIT-EX.
000247     EXIT.
000248*
...
000293         CALL  "_XPOWCWSETVISIBLE"  USING BY VALUE RSVLIST
000293          POW-0001 
000294         MOVE  1  TO POW-0002
000294         CALL  "_XPOWCWSETVISIBLE"  USING BY VALUE RSVLIST
000294          POW-0002 
000295     END-IF.
...
000308     CALL   "_XPOWTABLESETNUMERICTO"  USING BY VALUE ROOMTBL
000308      BY REFERENCE POW-0003  BY VALUE POW-0004 POW-0005 .
000309     MOVE  WK-RSV  TO POW-0006
000309     MOVE  TBL-IDX  TO POW-0007
000309     MOVE  2  TO POW-0008
000309     CALL   "_XPOWTABLESETNUMERICTO"  USING BY VALUE ROOMTBL
000309      BY REFERENCE POW-0006  BY VALUE POW-0007 POW-0008 .
000310     MOVE  WK-RITU-D  TO POW-0009
000310     MOVE  TBL-IDX  TO POW-0010
000310     MOVE  3  TO POW-0011
000310     CALL   "_XPOWTABLESETALPHANUMERICTO"  USING BY VALUE ROOMTBL
000310      BY REFERENCE POW-0009  BY VALUE POW-0010 POW-0011 .
000311*
000312 TBLEDIT-EX.
000313     EXIT.
000314*
...
000339         CALL    "_XPOWLISTDELSTRING"  USING BY VALUE RSVLIST 
000339         POW-0012 
000340     END-PERFORM.
000341*
...
000348         CALL    "_XPOWLISTADDSTRING"  USING BY VALUE RSVLIST
000348          BY REFERENCE POW-0013 
000349     END-PERFORM.
000350     MOVE  ROOM-RSV-NUM ( 7 )  TO POW-0014
000350     CALL  "_XPOWLISTSETSELECT"  USING BY VALUE RSVLIST
000350      POW-0014 .
000351*
...
000411     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000411      BY REFERENCE POW-0001 .
...
000421******************************************************************
000422     CALL  "_XPOWLISTGETSELSTRING"  USING BY VALUE RSVLIST  BY
000422      REFERENCE POW-0002 
...
000504     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000504      BY REFERENCE POW-0001 .
...
000551     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000551      BY REFERENCE POW-0001 .
...
000598     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000598      BY REFERENCE POW-0001 .
...
000643     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000643      BY REFERENCE POW-0001 .
...
000690     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000690      BY REFERENCE POW-0001 .
...
000737     CALL    "_XPOWCSOPENSHEET"  USING BY VALUE DEMO001
000737      BY REFERENCE POW-0001 .
...
000756     CALL    "_XPOWCSCLOSESHEET"  USING BY VALUE DEMO001
000756      BY REFERENCE POW-0001 .
000757*
000758 MAIN-EX.
000759     EXIT    PROGRAM.
